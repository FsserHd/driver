...
class ServicePage extends StatefulWidget {
  Function() updatePage;
  ServicePage(this.updatePage,  {super.key});

  @override
  _ServicePageState createState() => _ServicePageState();
}

class _ServicePageState extends StateMVC<ServicePage> with WidgetsBindingObserver {
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: (){
                                            _con.acceptService(context,serviceBean.id!,"Accepted","","all");
                                          },
                                        ),
                                        InkWell(
                                          onTap: (){
