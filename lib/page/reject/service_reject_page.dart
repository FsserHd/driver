...
class ServiceRejectPage extends StatefulWidget {

  String serviceId;
  ServiceRejectPage(this.serviceId, {super.key});

  @override
  _ServiceRejectPageState createState() => _ServiceRejectPageState();
}

class _ServiceRejectPageState extends StateMVC<ServiceRejectPage> {

  late HomeController _con;

  _ServiceRejectPageState() : super(HomeController()) {
              ...
              child: InkWell(
                onTap: (){
                  if(otherTextController.text.length >0  || selectedValue.length>0){
                    _con.acceptService(context, widget.serviceId, "Rejected",selectedValue,"all");
                  }else{
